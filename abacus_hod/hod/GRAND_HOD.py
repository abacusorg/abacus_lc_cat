        ...
        for i in range(hstart[tid], hstart[tid + 1]):
            if keep[i] == 1:
                ...
                if rsd:
                    ...
                    #lrg_z[j1] = pos[i,2] + lrg_vz[j1] * inv_velz2kms
                lrg_mass[j1] = mass[i]
                lrg_id[j1] = ids[i]
                j1 += 1
            elif keep[i] == 2:
                ...
                if rsd:
                    ...
                    #elg_z[j2] = pos[i,2] + elg_vz[j2] * inv_velz2kms
                elg_mass[j2] = mass[i]
                elg_id[j2] = ids[i]
                j2 += 1
            elif keep[i] == 3:
                ...
                if rsd:
                    ...
                    #qso_z[j3] = pos[i,2] + qso_vz[j3] * inv_velz2kms
                qso_mass[j3] = mass[i]
                qso_id[j3] = ids[i]
                j3 += 1
        ...
        for i in range(hstart[tid], hstart[tid + 1]):
            if keep[i] == 1:
                ...
                if rsd:
                    ...
                    #lrg_z[j1] = lrg_z[j1] + lrg_vz[j1] * inv_velz2kms
                lrg_mass[j1] = hmass[i]
                lrg_id[j1] = hid[i]
                j1 += 1
            elif keep[i] == 2:
                ...
                if rsd:
                    ...
                    #elg_z[j2] = elg_z[j2] + elg_vz[j2] * inv_velz2kms
                elg_mass[j2] = hmass[i]
                elg_id[j2] = hid[i]
                j2 += 1
            elif keep[i] == 3:
                ...
                if rsd:
                    ...
                    #qso_z[j3] = qso_z[j3] + qso_vz[j3] * inv_velz2kms
                qso_mass[j3] = hmass[i]
                qso_id[j3] = hid[i]
                j3 += 1
        # assert j == gstart[tid + 1]
