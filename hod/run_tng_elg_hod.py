...
f = asdf.open(os.path.join(sim_slices[1],'halo_info_lc.asdf'),lazy_load=True,copy_arrays=False)
header = f['header']
...
if __name__ == "__main__":
    ...
    for i in range(len(redshifts)):
        ...
        # TESTING if you don't need higher redshifts
        ...
        newparam['datadir'] = "/global/cscratch1/sd/boryanah/light_cone_catalog/"+sim_name+"/HOD/z%.3f"%redshift # where to save output
